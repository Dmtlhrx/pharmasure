  ...
  const renderMedicamentPage = () => (
    <div className="bg-white shadow-lg rounded-2xl p-6 space-y-6 border-2 border-teal-50">
      ...
      <form onSubmit={handleMedicamentSearch} className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="doctorNumber" className="block text-teal-700 mb-2">
              Numéro du Docteur
            </label>
            <div className="relative">
      ...
      {med.availability ? (
        <div className="flex flex-col space-y-2">
          {/* Bouton Acheter */}
          <button
            onClick={() => navigate('/PanierMedicaments')}
          ...
          {/* Bouton Commander */}
          <button
            onClick={() => navigate('/TrouverLivreur')}
            className="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-lg text-white w-full"
          >
            Commander
          </button>
        </div>
        ...
        // Bouton Contacter
        <button
          onClick={() => console.log(`Contacter ${med.pharmacy}`)}
          className="bg-red-500 hover:bg-red-600 px-4 py-2 rounded-lg text-white w-full"
        >
          Contacter
        </button>
      )}
